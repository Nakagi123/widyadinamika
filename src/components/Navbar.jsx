  ...
  return (
    <header className="bg-white shadow-md sticky top-0 z-50">
      <div className="container mx-auto px-4 py-3">
        ...
        >
          <nav className="flex flex-col space-y-1 py-4 border-t border-gray-200 bg-white">
            <Link
              to="/"
              className="text-gray-700 hover:text-violet-500 font-semibold transition-colors duration-200 px-2 py-2"
            ...
            {!isKasir && (
              <Link
                to="/cart"
                className="flex items-center gap-1 text-gray-700 hover:text-violet-500 font-semibold transition-colors duration-200 px-2 py-2"
                onClick={() => setIsMenuOpen(false)}
              >
                <ShoppingCart className="w-5 h-5" />
                Cart
            ...
            {isAuthenticated ? (
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-1 text-red-400 hover:text-red-500 font-semibold transition-colors duration-200 px-2 py-2"
                >
                  <LogOut className="w-4 h-4" />
                  Keluar
                </button>
